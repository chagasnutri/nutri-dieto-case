  ...
  static buildReportDocument(studentData, clinicalCase) {
    ...
    if (Array.isArray(caseBio) && caseBio.length > 0) {
      const bioRows = caseBio.map(item => {
        ...
        const interpAluno = (item.interpretacao && typeof item.interpretacao === "string" && item.interpretacao.trim())
          ? item.interpretacao.trim()
          : ((interps && typeof interps[item.exame] === "string" && interps[item.exame].trim()) 
    ...
    const rowsRecTotais = [
      ...
      ["  • Gordura Saturada (%)", recTotals.gorduraSaturadaPct ? `${recTotals.gorduraSaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
      ["  • Gordura Monoinsaturada (%)", recTotals.gorduraMonoinsaturadaPct ? `${recTotals.gorduraMonoinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
      ["  • Gordura Poli-insaturada (%)", recTotals.gorduraPoliinsaturadaPct ? `${recTotals.gorduraPoliinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
    ...
    if (isTne) {
      ...
      const rowsTotais = [
        ...
        ["  • Gordura Saturada (%)", totais.gorduraSaturadaPct ? `${totais.gorduraSaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
        ["  • Gordura Monoinsaturada (%)", totais.gorduraMonoinsaturadaPct ? `${totais.gorduraMonoinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
        ["  • Gordura Poli-insaturada (%)", totais.gorduraPoliinsaturadaPct ? `${totais.gorduraPoliinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
...
<body>
  ...
  ${renderTableHtml(
    ...
    [
      ...
      ["  • Gordura Saturada (%)", ca.totaisRecordatorio?.gorduraSaturadaPct ? `${ca.totaisRecordatorio.gorduraSaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
      ["  • Gordura Monoinsaturada (%)", ca.totaisRecordatorio?.gorduraMonoinsaturadaPct ? `${ca.totaisRecordatorio.gorduraMonoinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
      ["  • Gordura Poli-insaturada (%)", ca.totaisRecordatorio?.gorduraPoliinsaturadaPct ? `${ca.totaisRecordatorio.gorduraPoliinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico (R24h)"],
    ...
    : `
      ...
      ${renderTableHtml(
        ...
        [
          ...
          ["  • Gordura Saturada (%)", totaisCardapio?.gorduraSaturadaPct ? `${totaisCardapio.gorduraSaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
          ["  • Gordura Monoinsaturada (%)", totaisCardapio?.gorduraMonoinsaturadaPct ? `${totaisCardapio.gorduraMonoinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
          ["  • Gordura Poli-insaturada (%)", totaisCardapio?.gorduraPoliinsaturadaPct ? `${totaisCardapio.gorduraPoliinsaturadaPct} %` : "Não preenchido / ---", "Fracionamento lipídico planejado"],
