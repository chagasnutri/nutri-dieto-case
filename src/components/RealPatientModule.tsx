        ...
        <div className="bg-slate-850 border border-slate-800 rounded-2xl p-6 shadow-xl min-h-[420px]">
          ...
          {activeTab === 'conduta' && (
            <div className="space-y-4 text-xs">
              ...
              {/* Tabela Interativa de Cardápio com Recálculo Dinâmico por Quantidade */}
              <div className="bg-slate-900 rounded-xl border border-slate-800 p-4 text-xs space-y-3">
                <div className="flex items-center justify-between border-b border-slate-800 pb-2">
                  <div className="font-bold text-slate-200">Prescrição Dietética: Desjejum (07:30) • Cálculo Dinâmico Reativo</div>
                  <span className="text-[11px] font-bold text-indigo-400 bg-indigo-950/60 border border-indigo-800/80 px-2.5 py-0.5 rounded-full">
